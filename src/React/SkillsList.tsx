...
const SkillsList = () => {
  ...
  const skills = {
    ...
    "Data Analysis & Backend Logic": [
      "Analytics Engines & Data Visualization",
      "Relational Database Optimization",
      "Scalable Backend Workflows"
    ],
    "UI Integration & Prototyping": [
      "Translating Figma Mockups into Functional UI",
      "Custom SVG & Component Implementation",
